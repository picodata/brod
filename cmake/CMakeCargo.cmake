function(cargo_build)
    cmake_parse_arguments(CARGO "" "NAME" "" "FILE_RET" "" ${ARGN})
    ...
    set(LIB_FILE "${CARGO_TARGET_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${CMAKE_STATIC_LIBRARY_PREFIX}${LIB_NAME}.so")
    set(FILE_RET "${CARGO_TARGET_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${CMAKE_STATIC_LIBRARY_PREFIX}${LIB_NAME}.so" PARENT_SCOPE)
